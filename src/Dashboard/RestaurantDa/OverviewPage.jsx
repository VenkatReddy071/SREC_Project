...
        const statsRes = await axios.get(`${API_BASE_URL}/dashboard/stats`, config);
...
        const trendRes = await axios.get(`${API_BASE_URL}/dashboard/daily-trend`, config);
        setOrderTrendData(trendRes.data);
        setIsLoadingOrderChart(false);

        // Fetch Category Distribution
        setIsLoadingCategoryPie(true);
        const categoryRes = await axios.get(`${API_BASE_URL}/dashboard/category-distribution`, config);
        setCategoryData(categoryRes.data);
        setIsLoadingCategoryPie(false);

        // Fetch Payment Distribution
        setIsLoadingPaymentPie(true);
        const paymentRes = await axios.get(`${API_BASE_URL}/dashboard/payment-distribution`, config);
        setPaymentMethodData(paymentRes.data);
        setIsLoadingPaymentPie(false);

        // Fetch Time Summaries
        setIsLoadingTimeSummaries(true);
        const summariesRes = await axios.get(`${API_BASE_URL}/dashboard/time-summaries`, config);
...
        const recentOrdersRes = await axios.get(`${API_BASE_URL}/dashboard/recent-orders`, config);
...
      <section className="mb-8">
        <h2 className="text-3xl font-bold text-gray-900 mb-6">Recent Takeaway Orders</h2>
