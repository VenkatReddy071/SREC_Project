...
const TaxesAndCharges = () => {
  ...
  const fetchTaxes = async () => {
    ...
    try {
      ...
      const taxesRes = await axios.get(`${API_BASE_URL}/restaurants/my-restaurant/taxes`, {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      if (currentTax) {
        await axios.put(`${API_BASE_URL}/restaurants/my-restauranttaxes/${currentTax._id}`, taxData, {
          headers: { Authorization: `Bearer ${token}` },
          withCredentials: true,
        });
      } else {
        await axios.post(`${API_BASE_URL}/restaurants/my-restaurant/taxes`, taxData, {
          headers: { Authorization: `Bearer ${token}` },
          withCredentials: true,
        });
      }
  ...
  const handleDelete = async (taxId) => {
    ...
    try {
      ...
      await axios.delete(`${API_BASE_URL}/restaurants/taxes/${taxId}`, {
        headers: { Authorization: `Bearer ${token}` },
        withCredentials: true,
      });
      fetchTaxes();
