...
const menuItems = [
  ...
  { name: "Contact Us", path: "/hospital-dashboard/contact", icon: <FaEnvelope /> },
  {name:"Articles",path:'/hospital-dashboard/articles',icon:<FaComments />},
  { name: "outletInfo", path: "/hospital-dashboard/outlet", icon: <FaCog /> },
];
...
export const DashHomeHospital = () => {
  const [isOpen, setIsOpen] = useState(true);
    ...
    useEffect(() => {
      ...
      const fetchOutlet = axios.get(`${import.meta.env.VITE_SERVER_URL}/api/hospitals/outlet/email`, {
        headers: { Authorization: `Bearer ${token}` },
        withCredentials: true,
      });
