...
const baseMenuItems = [
  { name: "Dashboard", path: "/hospital-dashboard/:id", icon: <FaTachometerAlt /> },
  { name: "Doctors", path: "/hospital-dashboard/:id/doctors", icon: <FaHospitalSymbol /> },
  { name: "Bookings", path: "/hospital-dashboard/:id/bookings", icon: <FaShoppingCart /> },
  { name: "Customer Notifications", path: "/hospital-dashboard/:id/notifications", icon: <FaBell /> },
  { name: "Services Page", path: "/hospital-dashboard/:id/services", icon: <FaClinicMedical /> },
  { name: "Contact Us", path: "/hospital-dashboard/:id/contact", icon: <FaEnvelope /> },
  { name: "Articles", path: "/hospital-dashboard/:id/articles", icon: <FaComments /> },
  { name: "Outlet Info", path: "/hospital-dashboard/:id/outlet", icon: <FaCog /> },
];
          ...
          {isOpen ? (
            outletData ? (
              <div>
                ...
                <p className="text-sm text-gray-400 truncate">Address: {outletData.address || 'N/A'}</p>
                <p className="text-sm text-gray-400 truncate">Location: {outletData.locationName || 'N/A'}</p>
                <p className="text-sm text-gray-400 truncate">Phone: {outletData.phoneNumber || 'N/A'}</p>
            ...
            <div className="relative">
              ...
              {profileOpen && (
                <div className="absolute right-0 mt-2 w-48 bg-white border border-gray-200 rounded-lg shadow-lg py-1 z-30">
                  <NavLink
                    to={`/hospital-dashboard/${id}/profile`}
