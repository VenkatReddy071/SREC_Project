...
const menuItems = [
    { name: "Dashboard", path: "/education-dashboard", icon: <FaTachometerAlt /> },
    { name: "Institution Info", path: "/education-dashboard/info", icon: <FaHome /> },
    { name: "Teachers", path: "/education-dashboard/teachers", icon: <FaChalkboardTeacher /> },
    { name: "Contact Us", path: "/education-dashboard/contact", icon: <FaEnvelope /> },
];
