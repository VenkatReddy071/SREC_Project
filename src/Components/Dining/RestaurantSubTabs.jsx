...
export const RestaurantSubTabs = ({ activeTab, onTabChange,setIsSidebarOpen }) => {
  ...
  return (
    ...
    >
      ...
      `}</style>
      <div className="w-full md:max-w-7xl md:mx-auto py-3 px-4 items-center flex justify-between flex-wrap gap-2 md:gap-4">
                <div>
                  {tabs.map(tab => (
          <button
            key={tab.key}
          ...
          >
            {tab.label}
                ...
                className="w-full md:w-auto bg-blue-500 hover:bg-blue-600 text-white font-bold py-3 px-6 rounded-md transition-colors duration-300 flex items-center"
            >
