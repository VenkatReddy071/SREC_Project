...
export const ReviewsContent = () => {
  ...
  useEffect(()=>{
    const fetch=async()=>{
        try{
      const response=await axios.get(`${import.meta.env.VITE_SERVER_URL}/api/review/EducationalInstitute/${HospitalId}`,{withCredentials:true});
  ...
  const handleSubmitReview =async (e) => {
    ...
    const data={
      ...
      modelType:"EducationalInstitute",
    }
    try{
