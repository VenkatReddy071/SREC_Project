...
const [loading,setLoading]=useState(false);
  ...
  const handleAmbulance = () => {
    ...
    if (hospitalsSection) {
      hospitalsSection.scrollIntoView({ behavior: "smooth", block: "start" });
    } else {
      console.warn("Hospitals section element not found for scrolling.");
    }
  };
      ...
      <div className="md:flex md:gap-10 p-4 md:m-0 -mt-8">
        <div className="md:w-1/2 w-full lg:p-10 md:m-6">
          ...
          <div className="flex gap-1 items-center border border-gray-400 rounded">
            ...
            />
            <button className="bg-black text-white px-2 py-2 w-60" onClick={handleSubscribe}>{loading ?<div className="flex items-center">
                        <svg
