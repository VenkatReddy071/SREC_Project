        ...
        <div className="antialiased">
            ...
            <main className="container mx-auto px-4 py-8 pt-24 md:pt-28">
                ...
                <section className="text-center mb-16 px-4">
                    <h1 className="text-4xl md:text-5xl font-extrabold text-indigo-800 leading-tight mb-4 rounded-lg">
                        Welcome to <span className="text-green-600">NDLINFO</span>: Your Ultimate Online Hub
                    </h1>
                    <p className="text-xl text-gray-600 max-w-3xl mx-auto mb-8 rounded-lg">
                ...
                <section id="why-choose-us" className="mb-16 bg-gradient-to-br from-indigo-50 to-blue-100 p-8 md:p-12 rounded-xl  border border-blue-200">
                    <h2 className="text-3xl md:text-4xl font-bold text-center text-indigo-800 mb-10">
                        Why Choose <span className="text-green-600">NDLINFO</span>?
                    </h2>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                        <div className="bg-white p-6 rounded-lg shadow-md flex flex-col items-center text-center border-b-4 border-indigo-500 transform transition-transform duration-300 hover:scale-105 hover:shadow-lg">
                            <img src="https://placehold.co/100x100/e0e7ff/4338ca?text=Easy+UI" alt="User-Friendly Interface Icon" className="w-24 h-24 mb-4 rounded-full border-2 border-indigo-200 p-2" />
                        ...
                        <div className="bg-white p-6 rounded-lg shadow-md flex flex-col items-center text-center border-b-4 border-purple-500 transform transition-transform duration-300 hover:scale-105 hover:shadow-lg">
                            <img src="https://placehold.co/100x100/ede9fe/7c3aed?text=One+Stop" alt="One-Stop Solution Icon" className="w-24 h-24 mb-4 rounded-full border-2 border-purple-200 p-2" />
                        ...
                        <div className="bg-white p-6 rounded-lg shadow-md flex flex-col items-center text-center border-b-4 border-green-500 transform transition-transform duration-300 hover:scale-105 hover:shadow-lg">
                            <img src="https://placehold.co/100x100/d1fae5/059669?text=Secure+Tx" alt="Secure Transactions Icon" className="w-24 h-24 mb-4 rounded-full border-2 border-green-200 p-2" />
                        ...
                        <div className="bg-white p-6 rounded-lg shadow-md flex flex-col items-center text-center border-b-4 border-yellow-500 transform transition-transform duration-300 hover:scale-105 hover:shadow-lg">
                            <img src="https://placehold.co/100x100/fffbeb/d97706?text=24/7+Support" alt="Dedicated Support Icon" className="w-24 h-24 mb-4 rounded-full border-2 border-yellow-200 p-2" />
                    ...
                    <p className="mt-12 text-center text-xl text-gray-800 font-medium">
                        Join NDLINFO today and discover a world of convenience, efficiency, and quality at your fingertips!
                    </p>
                </section>

                <section id="healthcare" className="mb-16 bg-white p-8 md:p-12 rounded-xl  transform transition-transform duration-300 hover:scale-[1.01]">
                    <div className="flex flex-col md:flex-row items-center gap-8 md:gap-12">
                        <div className="md:w-1/2">
                            <img src="https://placehold.co/600x400/93c5fd/ffffff?text=Hospital+Appointment" alt="Hospital and Doctor Appointments" className="w-full h-auto object-cover rounded-lg shadow-md border-2 border-indigo-100" />
                        </div>
                        <div className="md:w-1/2">
                            ...
                            <div className="flex flex-col sm:flex-row gap-4">
                                <a href="/healthcare-page" className="inline-block bg-indigo-600 text-white px-6 py-3 rounded-full text-lg font-semibold  hover:bg-indigo-700 transition-colors duration-300 transform hover:scale-105 text-center">
                ...
                <section id="fashion" className="mb-16 bg-white p-8 md:p-12 rounded-xl  transform transition-transform duration-300 hover:scale-[1.01]">
                    <div className="flex flex-col md:flex-row-reverse items-center gap-8 md:gap-12">
                        <div className="md:w-1/2">
                            <img src="https://placehold.co/600x400/a78bfa/ffffff?text=Fashion+Shopping" alt="Fashion Clothing Shopping" className="w-full h-auto object-cover rounded-lg shadow-md border-2 border-purple-100" />
                        </div>
                        <div className="md:w-1/2">
                            ...
                            <ul className="list-disc list-inside text-gray-600 mb-6 space-y-2">
                                ...
                                <li>Receive **personalized recommendations** based on your browsing history and style preferences.</li>
                                <li>Enjoy **easy navigation** and a **secure checkout process** with multiple payment options.</li>
                            </ul>
                            <div className="flex flex-col sm:flex-row gap-4">
                                <a href="/fashion-page" className="inline-block bg-purple-600 text-white px-6 py-3 rounded-full text-lg font-semibold shadow-md hover:bg-purple-700 transition-colors duration-300 transform hover:scale-105 text-center">
                                    Shop Fashion Now
                                </a>
                ...
                <section id="education" className="mb-16 bg-white p-8 md:p-12 rounded-xl  transform transition-transform duration-300 hover:scale-[1.01]">
                    <div className="flex flex-col md:flex-row items-center gap-8 md:gap-12">
                        <div className="md:w-1/2">
                            <img src="https://placehold.co/600x400/6ee7b7/ffffff?text=School+College+Info" alt="Schools and Colleges Information" className="w-full h-auto object-cover rounded-lg shadow-md border-2 border-green-100" />
                        </div>
                        <div className="md:w-1/2">
                            ...
                            <div className="flex flex-col sm:flex-row gap-4">
                                <a href="/education-page" className="inline-block bg-green-600 text-white px-6 py-3 rounded-full text-lg font-semibold shadow-md hover:bg-green-700 transition-colors duration-300 transform hover:scale-105 text-center">
                                    Explore Education
                                </a>
                ...
                <section id="restaurants" className="mb-16 bg-white p-8 md:p-12 rounded-xl transform transition-transform duration-300 hover:scale-[1.01]">
                    <div className="flex flex-col md:flex-row-reverse items-center gap-8 md:gap-12">
                        <div className="md:w-1/2">
                            <img src="https://placehold.co/600x400/fbbf24/ffffff?text=Food+Delivery" alt="Restaurants and Food Ordering" className="w-full h-auto object-cover rounded-lg shadow-md border-2 border-yellow-100" />
                        </div>
                        <div className="md:w-1/2">
                            ...
                            <div className="flex flex-col sm:flex-row gap-4">
                                <a href="/restaurants-page" className="inline-block bg-yellow-600 text-white px-6 py-3 rounded-full text-lg font-semibold shadow-md hover:bg-yellow-700 transition-colors duration-300 transform hover:scale-105 text-center">
                                    Order Food Now
                                </a>
