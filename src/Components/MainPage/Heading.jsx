      ...
      <div className="bg-gray-800 py-16 px-4 sm:px-6 lg:px-8">
        <div className="max-w-md mx-auto text-center">
          ...
          <div className="mt-4 flex flex-col sm:flex-row gap-4">
            ...
            />
            <button className="w-full sm:w-auto bg-blue-600 text-white font-semibold py-3 px-6 rounded-full hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-400 focus:ring-opacity-50" onClick={handleSubscribe}>
