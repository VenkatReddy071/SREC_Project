...
const HeroSection = ({ title, description, primaryBtnText, secondaryBtnText, imageSrc }) => {
  return (
    <div className="relative w-full md:min-h-screen flex items-center justify-center  p-2">
      {/* Background Image */}
      {imageSrc && (
        <img
          src={imageSrc}
      ...
      <div className="relative z-10 text-center text-white bg-black bg-opacity-50 p-8 rounded-lg w-full">
        ...
        <p className="md:text-lg text-gray-300 max-w-2xl mx-auto mb-6">{description}</p>
