...
export const Showcase = ({
    ...
    const viewGalleryImage = (hospital?.gallery?.length >=1 && hospital.gallery[1]) ||(hospital?.imageUrls?.galleryImages?.length >=1 && hospital.imageUrls.galleryImages[1]) ||hospital?.imageUrls?.galleryImages[0];
    ...
    const getImageUrl = (relativePath) => {
        return `${import.meta.env.VITE_SERVER_URL}/${relativePath}`;
    };
    return (
